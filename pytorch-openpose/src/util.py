...
def overlay_heatmap(canvas, heatmap):
#     print(canvas, heatmap)
    assert canvas.shape[:2] == heatmap.shape, 'Shape mismatch between canvas and heatmap!'
    plt.figure()
    plt.subplot(121)
    plt.imshow(canvas[:, :, [2, 1, 0]], alpha=1.)
